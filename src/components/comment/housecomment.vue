<template>
  <div id="app">
    ...
    <div class="row">
      ...
      <div class="col-6 border border-1 border-dark" style="margin-left: 30px;margin-top: 50px">
    ...
    <!--右侧评论展示区-->
    <div class="row">
      <div class="col-4 offset-1 border border-1 border-dark" style="margin-bottom: 30px">

      </div>

      <div class="col-6 border border-1 border-dark"style="margin-left: 30px;margin-bottom: 30px">
        <div id="comment">
